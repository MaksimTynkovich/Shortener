  ...
  <div class="container center-vertically" id="container">
    ...
    <div class="content">
        ...
        <div class="form-group" >
          <div class="input-group mb-3">
            <input
                ...
                id="original_link"
                aria-describedby="original_link" placeholder="Ваша ссылка"
                :disabled="processing"
            />
            <div class="input-group-append">
              <button type="submit" class="btn btn-primary" :disabled="processing">Сократить</button>
            </div>
          </div>
        </div>
      </form>
      ...
      <div v-if="shortened">
        ...
        <button type="button" class="btn btn-light" @click="shortenAgain">Сократить новую ссылку</button>
      </div>
    </div>
